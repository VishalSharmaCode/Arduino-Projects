...
#define REPORTING_PERIOD_MS 6000 // frequency of updates sent to blynk app in ms
            

char ssid[]="Redmi9";
char password[]="vishalsharmaji";
char firebaseHost[]="https://auth-project-48bc8-default-rtdb.asia-southeast1.firebasedatabase.app/";
char firebaseKey[]="IzaSyBL7k8KFFLTylIJhb6DnfBT2qU3j6B1Yzo";
...
Serial.print("HeartRate:");
    ...
    Firebase.setInt("BPM",beatAvg);
    Firebase.setInt("SpO2",sp02Avg);
    Firebase.setFloat("Body Temperature",temperature);
    tsLastReport = millis();
    }
  }
}
